                                                                    ...
                                                                    <>
                                                                        <div className="flex justify-between items-center mb-1">
                                                                            ...
                                                                            <Button
                                                                                ...
                                                                                onClick={() => window.open(`https://docs.google.com/viewer?url=${encodeURIComponent(estimate.consultant_contract_path)}&embedded=true`, "_blank")}
                                                                            >
                                                                                Xem file hợp đồng
                                                                            </Button>
                                                                        </div>
                                                                ...
                                                                {estimate.customer_signed_contract_path && (
                                                                    <div className="flex justify-between items-center mb-1">
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            onClick={() => window.open(`https://docs.google.com/viewer?url=${encodeURIComponent(estimate.customer_signed_contract_path)}&embedded=true`, "_blank")}
                                                                        >
                                                                            Xem bản cứng
                                                                        </Button>
                                                                    </div>
