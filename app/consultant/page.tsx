...
export default function ConsultantPage() {
  ...
  const onFinish = (values: any) => {
    ...
    setTimeout(() => {
      ...
      message.success('Đã tạo đơn hàng thành công! Chuyển sang bộ phận Kế hoạch.');
      setLoading(false);
      form.resetFields();
      setEstimate(null);
    }, 1000);
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800 uppercase">Tạo đơn hàng mới</h1>
        </div>
        ...
        <Row gutter={24}>
            ...
            <Card title={<><CodeSandboxOutlined /> Thông tin đơn hàng</>} className="shadow-sm">
              ...
              >
                ...
                <Row gutter={16}>
                  <Col span={12}>
                    <Form.Item name="customerName" label="Tên khách hàng" rules={[{ required: true }]}>
                      <Input prefix={<UserOutlined />} placeholder="Ví dụ: Công ty Dược phẩm A" />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item name="deliveryDate" label="Ngày giao hàng (Dự kiến)" rules={[{ required: true }]}>
                      <DatePicker className="w-full" format="DD/MM/YYYY" />
                    </Form.Item>
                  </Col>
                </Row>

                <Divider style={{ borderColor: '#d9d9d9' }} titlePlacement="left">Thông số sản phẩm</Divider>
                ...
                <Row gutter={16}>
                  ...
                  <Col span={16}>
                    <Form.Item label="Kích thước (Dài x Rộng x Cao) mm" required>
                      <Space.Compact block>
                        <Form.Item name="length" noStyle>
                          <InputNumber style={{ width: '33%' }} placeholder="Dài" />
                        </Form.Item>
                        <Form.Item name="width" noStyle>
                          <InputNumber style={{ width: '33%' }} placeholder="Rộng" />
                        </Form.Item>
                        <Form.Item name="height" noStyle>
                          <InputNumber style={{ width: '34%' }} placeholder="Cao" />
                        </Form.Item>
                      </Space.Compact>
                    </Form.Item>
                  </Col>
                ...
                <Row gutter={16}>
                  <Col span={12}>
                    <Form.Item name="paperType" label="Loại giấy & Định lượng" rules={[{ required: true }]}>
                      <Select 
                  ...
                  <Col span={6}>
                    <Form.Item name="colors" label="Số màu in">
                      <InputNumber min={1} max={8} className="w-full" suffix="Màu" />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Form.Item>
                  <Button type="primary" htmlType="submit" size="large" loading={loading} block className="bg-blue-600">
                    Tạo đơn hàng
                  </Button>
                </Form.Item>
              </Form>
          ...
          <Col span={8}>
            <Card 
              title={<><CalculatorOutlined /> Ước tính & Tồn kho</>} 
              className="shadow-sm sticky top-6"
              extra={<Button size="small" onClick={handleCalculate}>Tính ngay</Button>}
            >
              {!estimate ? (
                ...
                <div className="space-y-6">
                  <Alert
                    title={estimate.isStockEnough ? "Đủ nguyên vật liệu" : "Thiếu nguyên vật liệu"}
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <Statistic 
                      ...
                      suffix="₫" 
                      precision={0}
                      styles={{ content: { color: '#108ee9', fontWeight: 'bold' } }}
                    />
                    <div className="text-xs text-gray-500 mt-1">
                  ...
                  <div className="border-t pt-4">
                    ...
                    <Steps
                      ...
                      // data giả định tính toán ngày giao hàng dự kiến sau này có thể xem xét thêm sau
                        ...
                        { title: 'Chuẩn bị vật tư', content: estimate.isStockEnough ? 'Có sẵn' : '3-5 ngày (Đặt hàng)' },
